        ...
        <asp:Wizard ID="Wizard1" runat="server" DisplaySideBar="False" ActiveStepIndex="0">
            <WizardSteps>
                ...
                <asp:WizardStep ID="WizardStep2" runat="server" Title="Step 2">
                    <contenttemplate>
                        <h2 class="text-center mb-5">Choose the Prize</h2>
                        <div class="container">
            ...
            <StepNavigationTemplate>
                <asp:Button ID="Button1" runat="server" Text="Previous" CommandName="MovePrevious" CssClass="btn btn-secondary" />
                <%--<asp:Button ID="btnStepPrevious" runat="server" Text="Previous" CommandName="MovePrevious" CssClass="btn btn-secondary" />--%>
            </StepNavigationTemplate>

            <FinishNavigationTemplate>
                <asp:Button ID="Button2" runat="server" Text="Previous" CommandName="MovePrevious" CssClass="btn btn-secondary" />
